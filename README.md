...
## Task
The task is to create an implementation of the Zsh in macOS and Linux. But this program is less functional than the original one.
...
## Usage
After building the binary file, you run it. After that, you use it as a regular Zsh. It has commands such as cd, ls, touch and which, etc.
```
make
```
